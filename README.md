...
- **[sounddeck](https://github.com/markksantos/sounddeck)** — Virtual audio mixer and soundboard for macOS
- **[FootageCalculator](https://github.com/markksantos/FootageCalculator)** — Scan a folder and instantly total your video footage duration
...
- **[google-chat-names](https://github.com/markksantos/google-chat-names)** — Google Chat display name utility extension

### 💼 Business & Productivity
- **[devlaunch](https://github.com/markksantos/devlaunch)** — Developer dashboard for managing local projects
- **[TaskFlow](https://github.com/markksantos/TaskFlow)** — Task management and workflow automation
...
- **[va-training-hub](https://github.com/markksantos/va-training-hub)** — Virtual assistant training and onboarding platform
...
- **[mvp-agi-2](https://github.com/markksantos/mvp-agi-2)** — Enhanced multi-agent AI with LangGraph
- **[Atlas](https://github.com/markksantos/Atlas)** — Multi-model AI orchestrator (OpenAI/Anthropic/Google)
- **[Archive ClawdBot](https://github.com/markksantos/Archive-ClawdBot)** — AI agent framework with persistent memory
- **[GeniusAIKeyboard](https://github.com/markksantos/GeniusAIKeyboard)** — AI-powered iOS keyboard extension using OpenAI GPT
- **[strategy-generator](https://github.com/markksantos/strategy-generator)** — YouTube strategy document generator — scrapes channels, analyzes with Gemini, builds blueprints with Claude
- **[ai-yt-title-generator](https://github.com/markksantos/ai-yt-title-generator)** — AI that reads YouTube transcripts and generates viral title ideas
- **[Nudge](https://github.com/markksantos/Nudge)** — Records, transcribes, and saves searchable meeting notes entirely on-device

### 💰 Finance & Legal
- **[basisguard](https://github.com/markksantos/basisguard)** — S-Corp shareholder basis tracker with what-if modeling
- **[propertytaxcut](https://github.com/markksantos/propertytaxcut)** — Property tax reduction service
- **[RentNegotiator](https://github.com/markksantos/RentNegotiator)** — Rent negotiation platform
...
- **[Flux](https://github.com/markksantos/Flux)** — Context-based workspace switcher with time tracking per project
...
- **[Fuse](https://github.com/markksantos/Fuse)** — Consolidates multiple menu bar apps into a single organized dropdown
...
- **[Pinch](https://github.com/markksantos/Pinch)** — Batch file compressor for images, videos, and PDFs with Finder integration
...
- **[VaultApp](https://github.com/markksantos/VaultApp)** — Encrypted file vault with Touch ID
- **[QuickLookPro](https://github.com/markksantos/QuickLookPro)** — Enhanced QuickLook previews for macOS
- **[dottoggle](https://github.com/markksantos/dottoggle)** — Finder extension to toggle hidden files
- **[ExtensionManager](https://github.com/markksantos/ExtensionManager)** — macOS extension browser/manager
- **[ExtensionTracker](https://github.com/markksantos/ExtensionTracker)** — System extension monitoring tool
- **[TextBold](https://github.com/markksantos/TextBold)** — Rich text editor for macOS
- **[HookCut](https://github.com/markksantos/HookCut)** — Keyboard shortcut utility
...
### 💑 Family & Personal
- **[babyhq](https://github.com/markksantos/babyhq)** — Baby tracking and management app
- **[babyhq-ios-app](https://github.com/markksantos/babyhq-ios-app)** — iOS companion app
- **[1on1](https://github.com/markksantos/1on1)** — Direct messaging for two — messages appear as large unmissable floating overlays
- **[coupleshield](https://github.com/markksantos/coupleshield)** — Legal document generator for couples
...
- **[Picmal](https://github.com/markksantos/Picmal)** — Photo management application
...
- **[mark-studios-sops](https://github.com/markksantos/mark-studios-sops)** — Internal SOPs & playbooks for inbox management and client communication
- **[mark-studios-extension](https://github.com/markksantos/mark-studios-extension)** — Chrome extension for Mark Studios workflow
...
- **[sovereign-blueprint-matrix](https://github.com/markksantos/sovereign-blueprint-matrix)** — Strategic planning framework
- **[MiniMaxProject](https://github.com/markksantos/MiniMaxProject)** — AI content creation suite
- **[new-app](https://github.com/markksantos/new-app)** — Experimental application
- **[todo-list-app](https://github.com/markksantos/todo-list-app)** — Simple task management
- **[Fala](https://github.com/markksantos/Fala)** — Communication experiment
- **[G-sheet_appsscript](https://github.com/markksantos/G-sheet_appsscript)** — Google Sheets automation scripts
- **[WorkID](https://github.com/markksantos/WorkID)** — Identity management system
